...
// Mock 資料：全年產季熱點矩陣
export const PROCUREMENT_MATRIX: ProcurementMatrixData = {
    草莓: {
                        ...
                        <div className="overflow-x-auto">
                            ...
                            >
                                ...
                                {MONTHS.map((month) => (
                                    <div
                                        key={month}
                                        className={`sticky top-0 z-20 border-b border-r border-gray-200 p-2 text-xs font-semibold text-center min-h-[48px] flex items-center justify-center ${month === currentMonth
                                ...
                                {INGREDIENTS.map((ingredient) => (
                                    <React.Fragment key={ingredient}>
                                        ...
                                        {/* 月份資料格 */}
                                        {MONTHS.map((month) => {
                                            const cell = PROCUREMENT_MATRIX[ingredient]?.[month] || {
                                            ...
                                            return (
                                                <div
                                                    key={month}
                                                    className={`border-b border-r border-gray-200 p-2 flex items-center justify-center min-h-[48px] hover:bg-gray-50 transition-colors ${isCurrentMonth
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-3 mt-4">
                        ...
                        <div className="mt-2 text-xs text-green-600">
                            {INGREDIENTS.filter((ing) => {
                                const cell = PROCUREMENT_MATRIX[ing]?.[currentMonth];
