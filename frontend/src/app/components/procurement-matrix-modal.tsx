            ...
            <div className="overflow-x-auto">
              ...
              >
                ...
                {MONTHS.map((month) => (
                  <div
                    key={month}
                    className={`sticky top-0 z-20 border-b border-r border-gray-200 p-2 text-xs font-semibold text-center min-h-[48px] flex items-center justify-center ${
                      month === currentMonth 
                  ...
                  <React.Fragment key={ingredient}>
                    ...
                    {MONTHS.map((month) => {
                      ...
                      return (
                        <div
                          key={month}
                          className={`border-b border-r border-gray-200 p-2 flex items-center justify-center min-h-[48px] hover:bg-gray-50 transition-colors ${
                            isCurrentMonth 
